...
function drawSaturn() {
  ...
  const planetGeometry = new THREE.SphereGeometry(120, 100, 100);
  ...
  const ringGeometry = new THREE.TorusGeometry(150, 12, 60, 160);
...
const stickGeometry = new THREE.CylinderGeometry(15, 15, 350, 32);
